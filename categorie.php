    ...
    <div class="card">
        <div class="card-header ">
            ...
            <h3 class="card-title categorie-right" align="right">
                <button type="button" name="new_categorie" class="btn btn-primary btn-sm add" id="new_categorie"><i
                            class="nav-icon fas fa-plus" aria-hidden="true"></i> Ajouter
                </button>
            </h3>
        </div>
        <!-- /.card-header -->
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="card-title categorie-right" align="right">
                <button type="button" name="new_marque" class="btn btn-primary btn-sm add" id="new_marque"><i
                            class="nav-icon fas fa-plus" aria-hidden="true"></i> Ajouter
                </button>
            </h3>
        </div>
...
<div id="marque_dialog" title="Nouvelle marque">
    <form method="post" id="marque_form">
        ...
        <div class="form-group">
            ...
            <input type="submit" name="form_action_marque" id="form_action_marque" class="btn btn-info"
